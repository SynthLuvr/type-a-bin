declare const RAW_COVERAGE_ENV = "TYPE_A_BIN_SUBPROCESS_COVERAGE_DIR";
/**
 ...
 * sync.
 */
declare const coverageHookUrl: () => string;
/**
 ...
 */
declare const hookPresentInNodeOptions: (nodeOptions: string) => boolean;
/**
 ...
 */
declare const stripCoverageHookFromNodeOptions: (nodeOptions: string) => string;
