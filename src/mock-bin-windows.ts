...
const bootstrapCode = (url: string): string =>
  ...
  `// Node with this script and passes the invoked mock executable and\n` +
  `// the caller's original arguments after it, so nothing between the\n` +
  `// spawn and the mock ever re-parses the command line.\n` +
